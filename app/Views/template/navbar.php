    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="<?= route_to('email/subscribers') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-airplay"></i></span><span class="pcoded-mtext">Email Subscribe</span></a>
                </li>
                <li class="nav-item">
